    ...
    <div className="relative w-full max-w-md search-container">
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-md border border-zinc-200 bg-white py-2 pl-10 pr-10 text-sm outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
        />
        {isLoading && (
      ...
      {showResults && (query.trim() || isLoading) && (
        <div className="absolute mt-1 w-full rounded-md border border-zinc-200 bg-white shadow-lg z-50">
