    ...
    return (
        <Button
            ...
            className={cn(
                ...
                isNewThread
                    ? 'cursor-default hover:text-zinc-500 text-zinc-500'
                    : 'text-zinc-500 hover:text-zinc-900 group/thread',
            )}
            onClick={e => {
                e.stopPropagation()
                onClick?.()
            ...
            <div className="flex items-center gap-2 flex-1">
                {isNewThread ? (
                    ...
                    <>
                        ...
                        <span>•</span>
                        <span>
                            {formatDistanceToNow(new Date(lastReplyAt!))} ago
                        </span>
                    </>
                )}
            </div>
